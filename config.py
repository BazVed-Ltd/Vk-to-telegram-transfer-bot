...
def initConfig():
	...
	setCell( "sleepTime", 0 ) # Задержка перед следующей проверкой на наличие новых сообщений. Просто не трогай...
	...
	setCell( "vk_login", "79934468655" ) # Логин от аккаунта ВК
	setCell( "vk_password", "c-?61pNGwehU'9&Q" ) # Пароль от аккаунта ВК

	setCell( "app_id", 2685278 ) # Приложение, у которого есть доступ взаимодействовать с ВК
	setCell( "telegram_token", "7878619010:AAGg1FuNcryr46FNi2yhco-ilm2yn6K6TII" ) # Токен ботинка в Telegram
	...
	setCell( "vk_album_id", 304528081 ) # ID альбома, куда будут заливаться стикеры из тележки
	...
	setCell( "vk_15", '-4506926210' ) # Пример переадресации из чата ВК в Telegram
	setCell( "t_-4506926210", '15' ) # Пример переадресации из чата ВК в Telegram
